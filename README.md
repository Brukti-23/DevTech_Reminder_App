"""
🎯 Reminder App (Python)
Created by: Bruktawit Menber Mandefro
For: DevTech Internship 2025
Description:
A console-based Reminder App that lets users set multiple reminders.
It notifies them at the specified time with alerts and messages.
"""
